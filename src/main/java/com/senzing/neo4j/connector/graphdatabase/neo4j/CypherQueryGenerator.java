...
public class CypherQueryGenerator {
  ...
  static public CypherQuery createNodeQuery(String nodeType, Map<String, Object> properties) {
  ...
  static public CypherQuery createRelationshipQuery(Map<String, Object> fromCriteria, Map<String, Object> toCriteria,
    ...
    String query = String.format(baseQuery, fromCriteriaString, toCriteriaString, relationshipType,
        propVariable.toString());
  ...
  static public CypherQuery deleteAndDetachRelatedNodesByRelationshipLabel(Map<String, Object> criteria,
  ...
  static private String generateExclusiveCriteria(Map<String, Object> inCriteria, String prefix) {
    List<String> criteriaElements = inCriteria.keySet().stream()
        .map(k -> prefix + "." + k + "=" + getStringValue(inCriteria.get(k))).collect(Collectors.toList());
